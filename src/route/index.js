  ...
  // ↙ сюди вводимо JSON дані
    ...
    main: {
      skills: [
			...
			hobbies: [
				{
					name: 'вишивання хрестиком',
					isMain: false,
				},
				{
					name: 'перегляд серіалів',
					isMain: false,
				},
				{
					name: 'грати',
					...
					projects: [
						{
							...
							awards: [
								{
									name: 'Background verification - is a feature thet provides users to prove that they are real person',
								},
								{
									name: 'Preparing SEO optimtzed pages. The automated process of getting data for the app from documents.',
								},
							],
							stackAmount: 3,
							awardAmount: 2,
